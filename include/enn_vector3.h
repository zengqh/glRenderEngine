...
namespace enn
{
	...
	public:
		...
		Vector3( const float afCoordinate[3] ) : x( afCoordinate[0] ), y( afCoordinate[1] ), z( afCoordinate[2] )
		{
		}

		Vector3( const int afCoordinate[3] ) : x( (float)afCoordinate[0] ), y( (float)afCoordinate[1] ), z( (float)afCoordinate[2] )
		{
		}
