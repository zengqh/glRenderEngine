...
namespace enn
{
	...
	public:
		...
		void setColumn( size_t iCol, const Vector3& v, float w )
		{
			ENN_ASSERT( iCol < 4 );
			m[0][iCol] = v.x;
			m[1][iCol] = v.y;
	...
	public:
		...
		void makeAxis( const Vector3& vx, const Vector3& vy, const Vector3& vz )
		{
			m[0][0] = vx.x; m[0][1] = vy.x; m[0][2] = vz.x; m[0][3] = 0;
			m[1][0] = vx.y; m[1][1] = vy.y; m[1][2] = vz.y; m[1][3] = 0;
			m[2][0] = vx.z; m[2][1] = vy.z; m[2][2] = vz.z; m[2][3] = 0;
			m[3][0] = 0.0;  m[3][1] = 0.0;  m[3][2] = 0.0;  m[3][3] = 1.0;
		}

		void setAxis( const Vector3& vx, const Vector3& vy, const Vector3& vz )
		{
			m[0][0] = vx.x; m[0][1] = vy.x; m[0][2] = vz.x;
			m[1][0] = vx.y; m[1][1] = vy.y; m[1][2] = vz.y;
			m[2][0] = vx.z; m[2][1] = vy.z; m[2][2] = vz.z;
		}
		...
		static Matrix4 getTransScale( const Vector3& s, const Vector3& t )
		{
			Matrix4 r;
			r.m[0][0] = s.x; r.m[0][1] = 0.0; r.m[0][2] = 0.0; r.m[0][3] = t.x;
			r.m[1][0] = 0.0; r.m[1][1] = s.y; r.m[1][2] = 0.0; r.m[1][3] = t.y;
			r.m[2][0] = 0.0; r.m[2][1] = 0.0; r.m[2][2] = s.z; r.m[2][3] = t.z;
			r.m[3][0] = 0.0; r.m[3][1] = 0.0; r.m[3][2] = 0.0; r.m[3][3] = 1.0;
	...
	public:
		...
		bool isAffine() const
		{
			return Math::realEqual(m[3][0], 0) && Math::realEqual(m[3][1], 0) && 
				Math::realEqual(m[3][2], 0) && Math::realEqual(m[3][3], 1);
		}
		...
		{
			ENN_ASSERT(isAffine() && m2.isAffine());
